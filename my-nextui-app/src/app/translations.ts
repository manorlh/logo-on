export const translations = {
  he: {
    ...
    uploadImages: {
      title: 'העלאת תמונות',
      formats: 'פורמטים מקובלים: JPG, PNG, JPEG',
      multiple: 'ניתן להעלות מספר תמונות בבת אחת',
      dropzone: 'גרור ושחרר תמונות כאן, או לחץ לבחירה',
      clear: 'נקה תמונות'
    },
    uploadLogo: {
      title: 'העלאת לוגו',
      formats: 'מומלץ פורמט PNG לשקיפות',
      single: 'לוגו אחד בכל פעם',
      dropzone: 'גרור ושחרר לוגו כאן, או לחץ לבחירה',
      clear: 'נקה לוגו'
    },
    logoPlacement: {
      title: 'עורך מיקום הלוגו',
      drag: 'לחץ וגרור את הלוגו למיקום הרצוי',
      preview: 'תצוגה מקדימה מתעדכנת בזמן אמת'
    },
    logoSize: {
      title: 'גודל לוגו',
      sliders: 'השתמש במחוונים או הזן מספרים לשינוי הגודל',
    ...
    payment: {
      title: 'תשלום',
      description: 'לעיבוד יותר משתי תמונות נדרש תשלום חד פעמי.',
      summary: 'סיכום הזמנה',
    ...
    results: {
      title: 'התמונות המעובדות שלך',
      warning: 'שים לב: התמונות יהיו זמינות רק כל עוד חלון זה פתוח. אנא הורד את התמונות לפני הסגירה.',
      closingWarning: 'שים לב! החלון נסגר בקרוב. אנא וודא שהורדת את כל התמונות הרצויות.',
      downloadAll: 'הורד את כל התמונות (ZIP)',
      downloadImage: 'הורד תמונה',
      confirmClose: {
        title: 'סגירת חלון התוצאות',
  ...
  en: {
    ...
    uploadImages: {
      title: 'Upload Images',
      formats: 'Accept formats: JPG, PNG, JPEG',
      multiple: 'You can upload multiple images at once',
      dropzone: 'Drag & drop images here, or click to select',
      clear: 'Clear Images'
    },
    uploadLogo: {
      title: 'Upload Logo',
      formats: 'PNG format recommended for transparency',
      single: 'One logo at a time',
      dropzone: 'Drag & drop logo here, or click to select',
      clear: 'Clear Logo'
    },
    logoPlacement: {
      title: 'Logo Placement Editor',
      drag: 'Click and drag the logo to position it',
      preview: 'Preview updates in real-time'
    },
    logoSize: {
      title: 'Logo Size',
      sliders: 'Use sliders or input numbers to adjust size',
    ...
    payment: {
      title: 'Payment',
      description: 'Processing more than two images requires a one-time payment.',
    ...
    results: {
      title: 'Your Processed Images',
      warning: 'Note: Images will only be available while this window is open. Please download your images before closing.',
      closingWarning: 'Warning! Window is closing soon. Make sure you have downloaded all desired images.',
      downloadAll: 'Download All Images (ZIP)',
  ...
  ar: {
    ...
    uploadImages: {
      title: 'تحميل الصور',
      formats: 'الصيغ المقبولة: JPG, PNG, JPEG',
      multiple: 'يمكنك تحميل عدة صور في وقت واحد',
      dropzone: 'اسحب وأفلت الصور هنا، أو انقر للاختيار',
      clear: 'مسح الصور'
    },
    uploadLogo: {
      title: 'تحميل الشعار',
      formats: 'يوصى بصيغة PNG للشفافية',
      single: 'شعار واحد في المرة',
      dropzone: 'اسحب وأفلت الشعار هنا، أو انقر للاختيار',
      clear: 'مسح الشعار'
    },
    logoPlacement: {
      title: 'عرض موقع الشعار',
      drag: 'اضغط واسحب الشعار إلى الموقع المطلوب',
      preview: 'تحديث العرض في الوقت الحقيقي'
    },
    logoSize: {
      title: 'حجم الشعار',
      sliders: 'استخدم المنقلات أو أدخل الأرقام لتعديل الحجم',
      ratio: 'تبديل نسبة الأبعاد للحفاظ على التناسق',
      width: 'العرض:',
      height: 'الإرتفاع:',
      maintainRatio: 'الحفاظ على نسبة الأبعاد',
      title_he: 'حجم الشعار',
      sliders_he: 'تحديث أبعاد الشعار باستخدام المنقلات أو الحقول الإدخال',
      ratio_he: 'تبديل نسبة الأبعاد للحفاظ على التناسق الأصلي',
      width_he: 'العرض:',
      height_he: 'الإرتفاع:',
      maintainRatio_he: 'الحفاظ على نسبة الأبعاد الأصلية'
    },
    generate: 'إنشاء الصور',
    language: 'اللغة',
    theme: {
      toggle: 'تبديل الوضع',
      dark: 'الوضع الظلامي',
    ...
    payment: {
      title: 'الدفع',
      description: 'المعالجة أكثر من صورتين تتطلب دفعًا مرة واحدة.',
      summary: 'ملخص الطلب',
    ...
    results: {
      title: 'الصور المعالجة بناءً على طلبك',
      warning: 'ملاحظة: ستكون الصور متاحة فقط أثناء فتح هذا النافذة. يرجى تحميل الصور قبل إغلاق النافذة.',
      closingWarning: 'تحذير! النافذة قيد الإغلاق. تأكد من تحميل جميع الصور المرغوبة.',
      downloadAll: 'تحميل جميع الصور (ZIP)',
      downloadImage: 'تحميل الصورة',
      confirmClose: {
        title: 'إغلاق نافذة النتائج',
        message: 'هل أنت متأكد أنك تريد إغلاق؟ جميع الصور التي لم تقم بتحميلها ستفقد.',
        confirm: 'نعم، إغلاق',
        cancel: 'لا، الاحتفاظ'
      },
      paymentRequired: 'لتحميل أكثر من 2 صورة وبدون المائية الموجودة، يتطلب دفعًا مرة واحدة.',
      paymentSuccess: 'شكرا لدفعك! الآن يمكنك تحميل جميع الصور التي لديك.',
      paymentRequired_he: 'لتحميل أكثر من 2 صورة وبدون المائية الموجودة، يتطلب دفعًا مرة واحدة.',
      paymentSuccess_he: 'شكرا لدفعك! الآن يمكنك تحميل جميع الصور التي لديك.',
      payNow: 'دفع الآن',
      payNow_he: 'دفع الآن'
    },
    processing: 'معالجة الصور...',
    errors: {
      noLogo: 'يرجى اختيار الشعار',
      noImages: 'يرجى اختيار صورة على الأقل',
      processingFailed: 'فشل المعالجة'
    },
    logoPosition: {
      title: 'موقع الشعار',
      position: 'الموقع',
      drag: 'أسحب الشعار مباشرة على الصورة أو استخدم التحكمات أدناه',
      instructions: 'استخدم المنقلات أو أدخل قيم البكسل الدقيقة لتحديد الموقع الدقيق',
      title_he: 'موقع الشعار',
      position_he: 'الموقع',
